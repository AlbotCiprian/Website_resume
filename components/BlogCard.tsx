...
export function BlogCard({ post }: { post: PostMeta }) {
  return (
    <Card className="group border-slate-200/80 bg-white/85 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-500/45 dark:border-white/10 dark:bg-zinc-900/70 dark:hover:border-cyan-400/45">
      <CardHeader>
